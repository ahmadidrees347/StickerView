...
public class TextSticker extends Sticker {
     ...
     */
    private final float maxTextSizePixels;

    /**
     * Lower bounds for text size.
     */
    private final float minTextSizePixels;
     ...
     */
    private final float lineSpacingExtra = 0.2f;
    ...
    public TextSticker(@NonNull Context context, @Nullable Drawable drawable) {
        ...
        maxTextSizePixels = convertSpToPx(28);
    ...
    @NonNull
    public TextSticker setTextStroke(float stroke) {
    ...
    @NonNull
    public TextSticker setTextSpacing(float spacing) {
    ...
    @NonNull
    public TextSticker setShadowLayer(float radius, float dx, float dy, @ColorInt int shadowColor) {
